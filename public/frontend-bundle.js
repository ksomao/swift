...
/* harmony import */ var _js_gsap_barba_gsap_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js/gsap/barba.gsap.js */ "./src/js/gsap/barba.gsap.js");
...
var animationAbout = {
  enter: function enter() {
    ...
    return tl.to('.nav-main', {
      ...
      opacity: 1
    }).from('.about-title', _animation_gsap__WEBPACK_IMPORTED_MODULE_0__.fadeInUp).from('.about-img-wrapper', _animation_gsap__WEBPACK_IMPORTED_MODULE_0__.fadeIn).from('.about-main-text p', _animation_gsap__WEBPACK_IMPORTED_MODULE_0__.fadeInUpStagger).to('.about-wrapper', {
...
/* harmony import */ var _index_gsap__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./index.gsap */ "./src/js/gsap/index.gsap.js");
...
_barba_core__WEBPACK_IMPORTED_MODULE_0___default().init({
  ...
  views: [{
    ...
    afterEnter: function afterEnter(data) {
      _about_gsap__WEBPACK_IMPORTED_MODULE_2__.animationAbout.enter().start();
    },
    beforeEnter: function beforeEnter(data) {
      _about_gsap__WEBPACK_IMPORTED_MODULE_2__.animationAbout.beforeEnter();
    }
  }, {
    namespace: 'home',
    afterEnter: function afterEnter(data) {
      _index_gsap__WEBPACK_IMPORTED_MODULE_3__.animationIndex.enter().start();
    },
    beforeEnter: function beforeEnter(data) {
      _index_gsap__WEBPACK_IMPORTED_MODULE_3__.animationIndex.beforeEnter();
    }
  }]
});
