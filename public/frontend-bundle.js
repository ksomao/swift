...
var animationAbout = {
  ...
  mainArticle: function mainArticle() {
    ...
    tl.to('.nav-main', {
      ...
      opacity: 1
    }).from('.about-title', _animation_gsap__WEBPACK_IMPORTED_MODULE_2__.fadeInUp).from('.about-img-wrapper', _animation_gsap__WEBPACK_IMPORTED_MODULE_2__.fadeIn).from('.about-img', _animation_gsap__WEBPACK_IMPORTED_MODULE_2__.deScale).from('.about-main-text p', _animation_gsap__WEBPACK_IMPORTED_MODULE_2__.fadeInUpStagger, "-=3").to('.about-wrapper', {
  ...
  reinitialization: function reinitialization() {
    gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set('.about-wrapper', {
      opacity: 0
    });
    gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set('.nav-main', {
      opacity: 0
    });
  },
  textScroll: function textScroll() {
    return gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to('.text-scroll', {
      scrollTrigger: {
        markers: true,
        trigger: ".text-scroll",
        start: '-=300',
